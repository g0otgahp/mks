            ...
            <table class="table table-bordered">
              ...
              <tbody>
                <?php $index =1; foreach ($order_item as $row): ?>
                  <?php $total_price[] = @$row['stock_price']*@$row['stock_amount'] ?>
                  ...
                  <tr>
                    ...
                    <td class="text-right">
                      ...
                      style="background-color: #f5bca2;"
                      class="form-control text-right"
                      type="number" step="any"
                      name="stock_price"
                      Max="<?php echo @$row['product_sale'] ?>"
                    ...
                    <td class="text-right"><?php echo number_format(@$row['stock_price']*@$row['stock_amount'], 2, '.', '') ?></div></td>
                  </tr>
                <?php endforeach; ?>
                <!--  -->
                <tr>
                ...
                <?php  for($i=0;$i<30;$i++){ ?>
                  <?php $total_sale[] = @$_SESSION['product'][$i]['product_sale']*@$_SESSION['product'][$i]['sale_quantity']?>
                  ...
                  <?php if(@$_SESSION['product'][$i]['product_key']!=""){ ?>
                    <tr>
                      ...
                      <td class="text-right"><?php echo number_format(@$_SESSION['product'][$i]['product_sale']*@$_SESSION['product'][$i]['sale_quantity'], 2, '.', '') ?></td>
                    </tr>
                    <?php } ?>
                    <?php  } ?>
                    <tr>
