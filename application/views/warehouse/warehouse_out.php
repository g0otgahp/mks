...
<body onLoad="getfocus()">
	<div id="page-wrapper">
		<div class="row">
			<div class="col-lg-12">
				<h1>นำสินค้าออกจากสต๊อก <small>ระบบบริหารจัดการคลังสินค้า <?php echo $config[0]['config_shop_name'] ?></small></h1>
				<ol class="breadcrumb">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="alert alert-danger" role="alert">
							<h3>จำนวนสินค้าไม่เพียงพอ</h3>
							<h4>สินค้า <?php echo $balance['product_code']." ".$balance['product_name'] ?></h4>
							จำนวนที่ต้องการ <?php echo number_format($balance['warehouse_amount'])." ( ในรายการ ".number_format($balance['w_temp'])." รวมเป็น ".number_format($balance['w_temp_sum'])." )"; ?> มากกว่า จำนวนคงเหลือ <?php echo number_format($balance['warehouse_balance']); ?>
						</div>
					</div>
				</div>
			<?php endif; ?>
